...
with bmy.select():
    ...
    from mlib.py.test.support import bigmemtest, _4G

import array
import unittest

with bmy.select():
    from mlib.py.io import BytesIO, DEFAULT_BUFFER_SIZE
...
with bmy.select():
    ...
    from mlib.py.test.support import threading_helper
    from mlib.py.test.support.os_helper import unlink
...
with bmy.select():
    from mlib.py.bz2 import BZ2File, BZ2Compressor, BZ2Decompressor
