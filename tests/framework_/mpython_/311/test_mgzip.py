...
with bmy.select():
    from mlib.py.subprocess import PIPE, Popen
    from mlib.py.test.support import os_helper
    from mlib.py.test.support import _4G, bigmemtest, requires_subprocess
...
class TestGzip(BaseTest):
    ...
    def test_read_with_extra(self):
        ...
        gzdata = b"\x1f\x8b\x08\x04\xb2\x17cQ\x02\xff" b"\x05\x00Extra" b"\x0bI-.\x01\x002\xd1Mx\x04\x00\x00\x00"
