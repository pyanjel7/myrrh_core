...
from ...interfaces import IRuntimeObject, IMyrrhOs, IERegistrySupplier


__all__ = ("RuntimeObjectManager",)


class RuntimeObjectManager(IERegistrySupplier):
    def __init__(self, myrrh_os: IMyrrhOs, max_fds: int | None = None) -> None:
    ...
    fds = eregistry_property("runtime.fds")
    procs = eregistry_property("runtime.procs")
