...
from ...interfaces import EWhence, EStatField
...
class FileStream(RuntimeObject, IFileInOutStream):
    ...
    def __init__(self, handle: int, path: str, name: str, service: IECoreStreamService):
    ...
    def seek(
        ...
        *,
        ...
        try:
            whence = {
                os.SEEK_CUR: EWhence.SEEK_CUR,
                os.SEEK_SET: EWhence.SEEK_SET,
                os.SEEK_END: EWhence.SEEK_END,
            }[whence].value
    ...
    def stat(self, *, extras: dict[str, typing.Any] | None = None) -> EStat:
        return EStat(**self.service.stat(self.ehandle, fields=EStatField.FILE.value))
